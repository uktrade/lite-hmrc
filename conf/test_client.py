...
class LiteHMRCTestClient(testcases.TestCase):
    ...
    def setUp(self):
        ...
        self.licence_usage_file_body = base64.b64encode(
            bytes(
                r"""1\fileHeader\CHIEF\SPIRE\usageData\201901130300\9876\
...
41\fileTrailer\7""",
        ...
        self.licence_update_reply_body = """MVxmaWxlSGVhZGVyXENISUVGXFNQSVJFXGxpY2VuY2VSZXBseVwyMDE5MDIwODAwMjVcNDk1NDMg
