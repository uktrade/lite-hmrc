    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('reply_pending', 'Reply Pending'), ('reply_received', 'Reply Received'), ('reply_sent', 'Reply Sent')], default='pending', max_length=20)),
                ('extract_type', models.CharField(choices=[('usage_update', 'Usage update'), ('usage_reply', 'Usage Reply'), ('licence_update', 'Licence Update'), ('licence_reply', 'Licence Reply')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('SPIRE', 'SPIRE'), ('LITE', 'LITE'), ('HMRC', 'HMRC')], max_length=10)),
                ('mail', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='mail.Mail')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action', models.CharField(choices=[('insert', 'Insert'), ('cancel', 'Cancel'), ('update', 'Update')], max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usage_update', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='mail.UsageUpdate')),
            ],
            options={
