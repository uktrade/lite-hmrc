...
class MultipleEmailRetrievalTests(LiteHMRCTestClient):
    ...
    dto_1 = EmailMessageDto(
        run_number=49543,
        sender=HMRC_ADDRESS,
        receiver=EMAIL_USER,
        body="lite licence reply",
        subject="ILBDOTI_live_CHIEF_licenceReply_49543_201901130300",
        attachment=["ILBDOTI_live_CHIEF_licenceReply_49543_201901130300", b"\\\\\\\\\\\\\\\\"],
        raw_data="qwerty",
    )
    dto_2 = EmailMessageDto(
        run_number=17,
        sender=SPIRE_ADDRESS,
        receiver=EMAIL_USER,
        body="spire licence update",
        subject="ILBDOTI_live_CHIEF_licenceUpdate_17_201901130300",
        attachment=["ILBDOTI_live_CHIEF_licenceUpdate_49543_201901130300", b"Hi my name is alice"],
        raw_data="qwerty",
    )
    dto_3 = EmailMessageDto(
        run_number=49541,
        sender=HMRC_ADDRESS,
        receiver=EMAIL_USER,
        body="spire licence reply",
        subject="ILBDOTI_live_CHIEF_licenceReply_49542_201901130300",
        attachment=["ILBDOTI_live_CHIEF_licenceReply_49542_201901130300", b"Hi my name is phillip"],
        raw_data="qwerty",
    )
