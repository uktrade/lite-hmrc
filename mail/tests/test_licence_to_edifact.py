...
class LicenceToEdifactTests(LiteHMRCTestClient):
    ...
    def test_single_siel(self):
        ...
        expected = (
            ...
            + "\\1234"
            + "\n2\\licence\\SIEL20200000001P\\insert\\GBSIEL/2020/0000001/P\\siel\\E\\20200602\\20220602"
    ...
    def test_update_edifact_file(self):
        ...
        expected = (
            ...
            + "{:04d}{:02d}{:02d}{:02d}{:02d}".format(now.year, now.month, now.day, now.hour, now.minute)
            + "\\1234"
            + "\n2\\licence\\SIEL20200000001P\\cancel\\GBSIEL/2020/0000001/P\\siel\\E\\20200602\\20220602"
            + "\n3\\end\\licence\\2"
            + "\n4\\licence\\SIEL20200000001Pa\\insert\\GBSIEL/2020/0000001/P/a\\siel\\E\\20200602\\20220703"
